...
class Login_window:
    def __init__(self, root):
        ...
        img_top = Image.open("./college_images/PES1.jpeg")
        img_top = img_top.resize((1530,780), Image.LANCZOS)
        ...
        #icons
        img3 = Image.open("./college_images/LoginIconAppl.png")
        ...
        img4 = Image.open("./college_images/lock-512.png")
        ...
        loginbutton = Button(main_frame,command=self.login, text = "Login",font=("times new roman" ,15, "bold"), bg="white", fg="black",bd=3,relief=RIDGE)
        loginbutton.place(x= 110, y=300,width=120, height=35)
        
        #RegisterButton
        regbutton = Button(main_frame,command=self.register_window,text = "New User Register",font=("times new roman" ,10, "bold"), bg="white", fg="black",borderwidth=0,relief=RIDGE)
        regbutton.place(x= 15, y=350,width=160)
        
        #forgetbutton
        passbutton = Button(main_frame, text = "Forgot Password",command=self.forgot_password_window,font=("times new roman" ,10, "bold"), bg="white", fg="black",borderwidth=0,relief=RIDGE)
    ...
    def login(self):
        if self.textuser.get() =="" or self.textpass.get() =="":
            ...
            conn = mysql.connector.connect(host = "localhost",user ="root", passwd = "7229900623", database = "mydata")
            my_cursor = conn.cursor()
            my_cursor.execute("select * from register where email=%s and confpass=%s",(
                                                                                    self.textuser.get(),
                                                                                    self.textpass.get()
                                                                                    ))
...
class Register:
    def __init__(self, root):
        ...
        #background image
        img_top = Image.open("./college_images/LNCT.jpg")
        img_top = img_top.resize((1530,780), Image.LANCZOS)
        ...
        #leftImage
        left_img = Image.open("./college_images/PESLogo.jpg")
        left_img = left_img.resize((470,550), Image.LANCZOS)
